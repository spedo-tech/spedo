    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SPO-light"), QVariant("light"));
    ui->theme->addItem(QString("SPO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SPO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SPO-traditional"), QVariant("trad"));
