    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Spedo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Spedo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and spedo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Spedo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Spedo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Spedo Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Spedo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Spedo addresses"));
    ...
    openAction->setStatusTip(tr("Open a spedo: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Spedo Core help message to get a list with possible Spedo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Spedo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Spedo network", "", count));
}
...
{
    QString strTitle = tr("Spedo Core"); // default title
