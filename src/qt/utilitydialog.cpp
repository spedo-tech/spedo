    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Spedo Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Spedo Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  spedo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Spedo in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SPO, 0.1 SPO, 1 SPO and 10 SPO -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Spedo Core is shutting down...") + "<br /><br />" +
