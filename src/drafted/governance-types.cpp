...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SpedoNetwork") type = SpedoNetwork;
    if(strType == "SpedoNetworkVariable") type = SpedoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SpedoNetwork) s = "SpedoNetwork";
    if(type == SpedoNetworkVariable) s = "SpedoNetworkVariable";
