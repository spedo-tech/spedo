 ...
 *
 *   // network
 *   CSpedoNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.spedo.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSpedoNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SpedoNetwork
// //   -- signature requirements : Key1(User)
// class CSpedoNetworkVariable : public CGovernanceObject
// {
// private:
