...
{
    if(fLiteMode) return; // ignore all Spedo related functionality
...
/*
    ...
    allow endless transaction that would bloat Spedo and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("spedo-privatesend");
