...
Only requiring some minor changes is spedo.cpp.
...
Changes to spedo.cpp
----------------------
spedo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
