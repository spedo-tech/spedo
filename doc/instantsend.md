...
This mechanism has been integrated into Bitcore-Node-Spedo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/spedocoin/insight-api-spedo#web-socket-api](https://github.com/spedocoin/insight-api-spedo#web-socket-api) 
* API: [https://github.com/spedocoin/insight-api-spedo#instantsend-transactions](https://github.com/spedocoin/insight-api-spedo#instantsend-transactions) 
...
By default, the Spedo Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Spedo Core daemon:
